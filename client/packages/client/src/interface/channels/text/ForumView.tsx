...
const TagChip = styled("button", { base: { padding: "4px 12px", borderRadius: "var(--pd-radius-xl)", fontSize: "13px", fontWeight: 500, cursor: "pointer", border: "1px solid var(--md-sys-color-outline-variant)", background: "transparent", color: "var(--md-sys-color-on-surface)", transition: "background-color var(--pd-transition-fast), border-color var(--pd-transition-fast), color var(--pd-transition-fast), box-shadow var(--pd-transition-fast)", "&:hover": { background: "var(--md-sys-color-surface-container-high)" } }, variants: { selected: { true: { background: "var(--md-sys-color-primary)", color: "var(--md-sys-color-on-primary)", borderColor: "var(--md-sys-color-primary)" } } } });
const ToolbarActions = styled("div", { base: { display: "flex", gap: "8px", alignItems: "center" } });
const SortButton = styled("button", { base: { display: "flex", alignItems: "center", gap: "4px", padding: "6px 12px", borderRadius: "var(--pd-radius-sm)", fontSize: "13px", fontWeight: 500, cursor: "pointer", border: "none", background: "var(--md-sys-color-surface-container)", color: "var(--md-sys-color-on-surface)", transition: "background-color var(--pd-transition-fast), border-color var(--pd-transition-fast), color var(--pd-transition-fast), box-shadow var(--pd-transition-fast)", "&:hover": { background: "var(--md-sys-color-surface-container-high)" } } });
const CreateButton = styled("button", { base: { display: "flex", alignItems: "center", gap: "4px", padding: "6px 16px", borderRadius: "var(--pd-radius-sm)", fontSize: "13px", fontWeight: 600, cursor: "pointer", border: "none", background: "var(--md-sys-color-primary)", color: "var(--md-sys-color-on-primary)", transition: "background-color var(--pd-transition-fast), border-color var(--pd-transition-fast), color var(--pd-transition-fast), box-shadow var(--pd-transition-fast)", "&:hover": { opacity: 0.9 } } });
const CreateForm = styled("div", { base: { display: "flex", flexDirection: "column", gap: "8px", padding: "16px", borderRadius: "var(--pd-radius-lg)", background: "var(--pd-surface-raised)", border: "1px solid var(--md-sys-color-outline-variant)" } });
const formInput = css({ padding: "10px 14px", borderRadius: "var(--pd-radius-sm)", border: "1px solid var(--md-sys-color-outline-variant)", background: "var(--md-sys-color-surface-container-low)", color: "var(--md-sys-color-on-surface)", fontSize: "15px", fontWeight: 600, outline: "none", "&:focus": { borderColor: "var(--md-sys-color-primary)" } });
const formTextarea = css({ padding: "10px 14px", borderRadius: "var(--pd-radius-sm)", border: "1px solid var(--md-sys-color-outline-variant)", background: "var(--md-sys-color-surface-container-low)", color: "var(--md-sys-color-on-surface)", fontSize: "14px", outline: "none", resize: "vertical", minHeight: "60px", fontFamily: "inherit", "&:focus": { borderColor: "var(--md-sys-color-primary)" } });
const FormActions = styled("div", { base: { display: "flex", alignItems: "center", justifyContent: "flex-end", gap: "12px" } });
const SubmitButton = styled("button", { base: { display: "flex", alignItems: "center", gap: "6px", padding: "8px 18px", borderRadius: "var(--pd-radius-sm)", fontSize: "14px", fontWeight: 600, cursor: "pointer", border: "none", background: "var(--md-sys-color-primary)", color: "var(--md-sys-color-on-primary)", transition: "background-color var(--pd-transition-fast), border-color var(--pd-transition-fast), color var(--pd-transition-fast), box-shadow var(--pd-transition-fast)", "&:hover": { opacity: 0.9 }, "&:disabled": { opacity: 0.5, cursor: "not-allowed" } } });
const ThreadGrid = styled("div", { base: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: "var(--gap-md)" } });
const ThreadCard = styled("div", { base: { display: "flex", flexDirection: "column", gap: "8px", padding: "16px", borderRadius: "var(--pd-radius-lg)", background: "var(--pd-surface-raised)", boxShadow: "var(--pd-shadow-raised)", border: "1px solid var(--pd-border-subtle)", cursor: "pointer", transition: "background-color var(--pd-transition-fast), border-color var(--pd-transition-fast), color var(--pd-transition-fast), box-shadow var(--pd-transition-fast)", border: "1px solid transparent", "&:hover": { background: "var(--md-sys-color-surface-container-high)", borderColor: "var(--md-sys-color-outline-variant)" } } });
...
const ThreadInfo = styled("div", { base: { display: "flex", gap: "12px", alignItems: "center", fontFamily: "var(--pd-font-mono)", fontSize: "var(--pd-text-xs)", fontVariantNumeric: "tabular-nums", color: "var(--md-sys-color-on-surface-variant)" } });
...
const MiniTag = styled("span", { base: { padding: "3px 8px", borderRadius: "var(--pd-radius-pill)", fontFamily: "var(--pd-font-mono)", fontSize: "var(--pd-text-xs)", textTransform: "uppercase", letterSpacing: "var(--pd-tracking-wide)", background: "var(--md-sys-color-secondary-container)", color: "var(--md-sys-color-on-secondary-container)" } });
const ThreadActivity = styled("div", { base: { display: "flex", alignItems: "center", gap: "4px", fontFamily: "var(--pd-font-mono)", fontSize: "var(--pd-text-xs)", fontVariantNumeric: "tabular-nums", color: "var(--md-sys-color-on-surface-variant)" } });
