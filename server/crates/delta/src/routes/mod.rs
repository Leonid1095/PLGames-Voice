...
fn custom_openapi_spec() -> OpenApi {
    ...
    extensions.insert(
        "x-logo".to_owned(),
        json!({
            "url": "https://plgames-voice.ru/assets/logo.png",
            "altText": "PLG Voice"
        }),
    );
    ...
    OpenApi {
        ...
        info: Info {
            title: "PLG Voice API".to_owned(),
            description: Some("Voice and text messenger by PLG Games.".to_owned()),
            terms_of_service: Some("https://plgames-voice.ru/terms".to_owned()),
            contact: Some(Contact {
                name: Some("PLG Voice Support".to_owned()),
                url: Some("https://plgames-voice.ru".to_owned()),
                email: Some("support@plgames-voice.ru".to_owned()),
                ..Default::default()
            }),
            license: Some(License {
                name: "AGPLv3".to_owned(),
                url: Some("https://plgames-voice.ru/license".to_owned()),
                ..Default::default()
            }),
        ...
        servers: vec![
            Server {
                url: "https://plgames-voice.ru/api".to_owned(),
                description: Some("PLG Voice Production".to_owned()),
                ..Default::default()
            },
            Server {
                url: "http://localhost:14702".to_owned(),
                description: Some("Local Development".to_owned()),
                ..Default::default()
            },
            Server {
                url: "http://localhost:14702/0.8".to_owned(),
                description: Some("Local Development (v0.8)".to_owned()),
                ..Default::default()
            },
        ],
        external_docs: Some(ExternalDocs {
            url: "https://plgames-voice.ru".to_owned(),
            description: Some("PLG Voice Documentation".to_owned()),
            ..Default::default()
        }),
        extensions,
        tags: vec![
            Tag {
                name: "Core".to_owned(),
                description: Some(
                    "Use in your applications to determine information about the PLG Voice node"
                        .to_owned(),
                ),
                ..Default::default()
            },
            Tag {
                ...
                description: Some("Query and fetch users".to_owned()),
                ..Default::default()
            },
            Tag {
                name: "Direct Messaging".to_owned(),
                description: Some("Direct message other users".to_owned()),
                ..Default::default()
            },
            Tag {
            ...
            Tag {
                ...
                description: Some("Query and fetch channels".to_owned()),
                ..Default::default()
            },
            Tag {
            ...
            Tag {
                ...
                description: Some("Query and fetch servers".to_owned()),
                ..Default::default()
            },
            Tag {
            ...
            Tag {
                ...
                description: Some(
                    "After signing up, users must pick a unique username".to_owned(),
                ),
                ..Default::default()
            },
            Tag {
            ...
            Tag {
                ...
                description: Some(
                    "Subscribe to and receive push notifications while offline".to_owned(),
                ),
                ..Default::default()
            },
            Tag {
