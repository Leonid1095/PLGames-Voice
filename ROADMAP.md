...
| # | Задача | Описание | Статус |
|---|--------|----------|--------|
| 24 | Текстовые каналы | Создание, отправка сообщений, файлы, эмбеды | ⬜ |
| 25 | Голосовые каналы | Подключение, микрофон, индикатор говорящего | ⬜ |
| 26 | Авторизация | Регистрация, вход, 2FA | ⬜ |
| 27 | Управление сервером | Роли, каналы, настройки, инвайты | ⬜ |
| 28 | Русская локализация | Проверить все экраны на корректность перевода | ⬜ |
...
|-----------|---------|----------|
| Высокий | Krisp шумоподавление | `@livekit/krisp-noise-filter` — AI-шумоподавление лучше браузерного |
...
*Последнее обновление: 2026-03-09 (UX, i18n, голос, премиум-каркас)*
