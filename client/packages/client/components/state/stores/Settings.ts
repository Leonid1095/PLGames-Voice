...
interface SettingsDefinition {
   ...
   * PLG Voice will try to get notification permission after login if it doesn't already.
   * TODO: implement
   */
  ...
  /**
   * Indicate new users to PLG Voice
   * TODO: implement
   */
  ...
  /**
   * Streamer mode — hides sensitive info (email, invite links, DM content)
   */
