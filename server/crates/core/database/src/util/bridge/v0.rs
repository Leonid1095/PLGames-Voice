...
impl From<crate::PartialChannel> for PartialChannel {
    fn from(value: crate::PartialChannel) -> Self {
        PartialChannel {
            ...
            forum: value.forum.map(|f| f.into()),
            parent: value.parent,
            tags: value.tags,
        }
    }
...
impl From<FieldsChannel> for crate::FieldsChannel {
    fn from(value: FieldsChannel) -> Self {
        match value {
            ...
            FieldsChannel::Forum => crate::FieldsChannel::Forum,
        }
    }
}
...
impl From<crate::FieldsChannel> for FieldsChannel {
    fn from(value: crate::FieldsChannel) -> Self {
        match value {
            ...
            crate::FieldsChannel::Forum => FieldsChannel::Forum,
        }
    }
}
...
impl From<crate::FieldsServer> for FieldsServer {
    fn from(value: crate::FieldsServer) -> Self {
        match value {
            ...
            // DB-only variants — map to Description as fallback
            crate::FieldsServer::Starboard => FieldsServer::Description,
            crate::FieldsServer::WelcomeMessage => FieldsServer::Description,
        }
    }
}
...
impl From<ForumSortOrder> for crate::ForumSortOrder {
    fn from(value: ForumSortOrder) -> Self {
        match value {
            ForumSortOrder::Latest => crate::ForumSortOrder::Latest,
            ForumSortOrder::Oldest => crate::ForumSortOrder::Oldest,
            ForumSortOrder::MostActive => crate::ForumSortOrder::MostActive,
        }
    }
}
...
impl From<crate::ForumSortOrder> for ForumSortOrder {
    fn from(value: crate::ForumSortOrder) -> Self {
        match value {
            crate::ForumSortOrder::Latest => ForumSortOrder::Latest,
            crate::ForumSortOrder::Oldest => ForumSortOrder::Oldest,
            crate::ForumSortOrder::MostActive => ForumSortOrder::MostActive,
        }
    }
}
...
impl From<ForumInformation> for crate::ForumInformation {
    fn from(value: ForumInformation) -> Self {
        crate::ForumInformation {
            default_sort: value.default_sort.map(|s| s.into()),
            tags: value.tags.map(|tags| tags.into_iter().map(|t| t.into()).collect()),
        }
    }
}
