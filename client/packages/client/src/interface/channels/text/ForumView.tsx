...
const ThreadCard = styled("div", { base: { display: "flex", flexDirection: "column", gap: "8px", padding: "16px", borderRadius: "var(--borderRadius-lg)", background: "var(--md-sys-color-surface-container)", cursor: "pointer", transition: "background-color var(--pd-transition-fast), border-color var(--pd-transition-fast), color var(--pd-transition-fast), box-shadow var(--pd-transition-fast)", border: "1px solid transparent", "&:hover": { background: "var(--md-sys-color-surface-container-high)", borderColor: "var(--md-sys-color-outline-variant)" } } });
...
const MiniTag = styled("span", { base: { padding: "2px 8px", borderRadius: "var(--pd-radius-md)", fontSize: "11px", fontWeight: 500, background: "var(--md-sys-color-secondary-container)", color: "var(--md-sys-color-on-secondary-container)" } });
