...
auto_derived_partial!(
    ...
    pub struct Server {
        ...
        /// Auto-assigned role IDs for new members
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        pub auto_roles: Vec<String>,

        /// Custom welcome message template ({user}, {server}, {count})
        #[serde(skip_serializing_if = "Option::is_none")]
        pub welcome_message: Option<String>,

        /// Starboard configuration
        #[serde(skip_serializing_if = "Option::is_none")]
        pub starboard: Option<StarboardConfig>,

        /// Whether XP/leveling system is enabled
        #[serde(skip_serializing_if = "crate::if_false", default)]
        ...
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        pub reaction_roles: Vec<ReactionRoleMapping>,
    },
    "PartialServer"
);
...
auto_derived!(
    ...
    pub struct StarboardConfig {
        /// Channel ID for starboard posts
        pub channel: String,
        /// Emoji to track (default: star unicode)
        #[serde(default = "StarboardConfig::default_emoji")]
        pub emoji: String,
        /// Minimum reactions to trigger starboard
        #[serde(default = "StarboardConfig::default_threshold")]
        pub threshold: u32,
    }

    /// Reaction role mapping
    pub struct ReactionRoleMapping {
        /// Message ID that has the reaction
    ...
    pub struct AutomodConfig {
        /// Blocked words/phrases (exact match, case-insensitive)
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        pub blocked_words: Vec<String>,
        /// Max messages per interval before auto-mute
        #[serde(default)]
        pub spam_max_messages: u32,
        /// Interval in seconds for spam detection
        #[serde(default)]
        pub spam_interval_seconds: u32,
        /// Mute duration in seconds when spam detected
        #[serde(default)]
        pub spam_mute_duration: u32,
...
impl Server {
    ...
    pub fn remove_field(&mut self, field: &FieldsServer) {
        match field {
            ...
            FieldsServer::Starboard => self.starboard = None,
            FieldsServer::WelcomeMessage => self.welcome_message = None,
        }
    }
