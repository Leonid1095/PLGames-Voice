...
auto_derived!(
    ...
    /// Content type filter for message search
    ...
    pub struct DataMessageSearch {
        ...
        /// Filter by content type (attachment, embed, link, mention)
    ...
    pub async fn from(msg: Message, author: Option<MessageAuthor<'_>>, channel: Channel) -> Self {
        ...
        Self {
            author: author
                ...
                .unwrap_or_else(|| "PLGames Voice".to_string()),
            icon,
            image,
            body,
