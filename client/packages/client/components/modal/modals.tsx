...
import { CreateTempChannelModal } from "./modals/CreateTempChannel";
...
export function RenderModal(props: ActiveModal & { onClose: () => void }) {
  ...
  switch (modalProps.type) {
    ...
    case "create_temp_channel":
      return <CreateTempChannelModal {...modalProps} />;
    ...
    case "activity":
      return <ActivityModal {...modalProps} />;
    case "delete_bot":
    ...
    case "forward_message":
      return <ForwardMessageModal {...(modalProps as any)} />;
    case "create_poll":
      return <CreatePollModal {...(modalProps as any)} />;
    case "error2":
